...
def Action(send) :   
    ...
    if "what is your name" in   data_btn :
      ...
      return "my name is virtual Assistant"
        ...
        return "google open"
    # remember to pass the argument and keyword properly because it would only define the 
    #code length and the prompt given to the ai assitant
    #you could pass the parameter as per the command being operated.....
    #
